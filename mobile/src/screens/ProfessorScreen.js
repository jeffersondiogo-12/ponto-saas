import BarraInferior from '../navigation/BarraInferior';

/**
 * A antiga tela unica do professor virou o "Hub de fichas": a navegacao por
 * barra inferior (Inicio, Agenda, botao central de Chamada, Relatorios e
 * Sincronizar). Notas e Observacoes viraram telas proprias, abertas pelo
 * stack a partir do Inicio.
 */
export default function ProfessorScreen(props) {
  return <BarraInferior {...props} />;
}
    try {
