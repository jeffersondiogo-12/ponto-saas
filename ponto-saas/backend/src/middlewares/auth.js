 ...
 * acessar rotas de staff e vice-versa. O professor compartilha a mesma
 * familia de acesso do staff, mas com tipo 'professor' no payload.
 */
function exigirTipo(tipoEsperado) {
  return (req, res, next) => {
    ...
    const tiposPermitidos = [tipoEsperado];
    if (tipoEsperado === 'staff') {
      tiposPermitidos.push('professor');
    }
